...
const englishMessages = {
  ...
  curatorDescription: 'Review the regenerated portable draft before adding it to global memory.',
...
const japaneseMessages = {
  ...
  curatorDescription: '汎用化して再生成したドラフトを確認し、Global記憶に追加します。',
...
const simplifiedChineseMessages = {
  ...
  curatorBadge: '需要用户确认',
  curatorDescription: '审核重新生成的通用草稿，然后将其添加到全局记忆。',
...
const koreanMessages = {
  ...
  curatorDescription: '일반화해 재생성한 초안을 검토한 뒤 Global 메모리에 추가합니다.',
